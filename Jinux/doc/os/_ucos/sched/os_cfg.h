...
#define OS_MAX_TASKS             14u   /* Max. number of tasks in your application, MUST be >= 2       */
...
#define OS_TASK_STAT_STK_SIZE    40u   /* Statistics task stack size (# of OS_STK wide entries)        */
