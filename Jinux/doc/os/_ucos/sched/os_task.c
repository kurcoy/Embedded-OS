...
#endif
    p_stk_data->OSFree = nfree * sizeof(OS_STK);          /* Store   number of free entries on the stk     */
    p_stk_data->OSUsed = (size - nfree) * sizeof(OS_STK); /* Compute number of entries used on the stk     */
    return (OS_ERR_NONE);
}
#endif
/*$PAGE*/
